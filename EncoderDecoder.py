...
maxpo2 = MaxPool2D(pool_size=2, strides=2)(dconv2)
...
uconv3 = Conv2D(filters=64, kernel_size=3, padding="same", activation="relu")(uconv2)
# conca2 = Concatenate(axis=3)([dconv2a, dconv2])
# uconv4 = Conv2D(filters=64, kernel_size=3, padding="same", activation="relu")(conca2)
flatting = tf.keras.layers.Flatten()(uconv3)
